// Post-Quiz Page 
// File: /app/quiz/post/[sessionId]/[userId]/page.tsx
...
export default function PostQuizPage() {
  ...
  useEffect(() => {
    const loadQuiz = async () => {
      ...
      // Fetch Round to get Post-Quiz ID
      ...
      const postQuizId = roundSnap.data().postQuizId;
      if (!postQuizId) {
        setMessage('No Post-Quiz assigned for this round.');
        setLoading(false);
        return;
      }

      // ✅ Fetch Quiz Questions from Subcollection
      const questionsSnapshot = await getDocs(collection(db, 'Quizzes', postQuizId, 'Questions'));
  ...
  if (completed) return <p>You have already completed this post-game quiz. Thank you!</p>;

  return (
    <div className="p-4 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Post-Game Quiz</h1>
